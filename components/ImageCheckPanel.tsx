        ...
        {!file ? (
          ...
          >
            ...
            >
              ...
              <p className="text-xs text-text-2 sm:text-sm">Drag & drop a JPG/PNG, or click to browse</p>
              <div className="flex items-center gap-1.5 sm:gap-2">
                <span className="glass-border rounded-md bg-elevated/60 px-2 py-0.5 text-xs font-medium text-text-3 sm:px-2.5 sm:py-1">JPG</span>
                <span className="glass-border rounded-md bg-elevated/60 px-2 py-0.5 text-xs font-medium text-text-3 sm:px-2.5 sm:py-1">PNG</span>
              </div>
          ...
          >
            {previewUrl && (
              ...
              <img
                ...
                className="h-14 w-14 max-h-37.5 shrink-0 rounded-xl object-cover sm:h-16 sm:w-16 sm:max-h-50"
              />
            )}
